...
LIBS=-lncursesw 
OBJS=$(OBJDIR)/wdisplay.o $(OBJDIR)/mhw_lookup.o $(OBJDIR)/main.o $(OBJDIR)/utils.o $(OBJDIR)/ui.o $(OBJDIR)/memory.o $(OBJDIR)/patterns.o 
EXEC=linux-hunter
...
$(OBJDIR)/main.o: src/main.cpp src/memory.h src/patterns.h src/ui.h src/timer.h \
 src/vbrush.h src/wdisplay.h src/events.h src/mhw_lookup.h src/utils.h $(OBJDIR)/__setup_obj_dir
